...
class Creature
{
   ...
   *****************************************************/
public:
Creature(string const& nom_recu ) : nom(nom_recu){}
...
public:
  Dragon(string const& nom_recu, double const& feu)
  :Creature(nom_recu), portee(feu)
  {}
...
public:
  Hydre(string const& nom_recu, double const& poison)
  :Creature(nom_recu), poison(poison)
  {}
...
/*******************************************
 * Ne rien modifier après cette ligne.const
 *******************************************/
int main()
{
